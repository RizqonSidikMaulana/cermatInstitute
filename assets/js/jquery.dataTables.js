...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<div class="col-xs-4 pull-right"><input type="search" class="form-control'+classes.sFilterInput+'" style="bottom:20px;right:10px;  position:absolute;" placeholder="Masukan data yang dicari"/></div>';
